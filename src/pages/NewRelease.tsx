            ...
            <div className="relative z-10 p-5 md:p-10 max-w-7xl mx-auto space-y-12">
                ...
                {isEditMode && rejectionReason && (
                    <div className="rounded-2xl border border-red-600/20 bg-red-600/[0.06] p-5 flex items-start gap-4">
                        <AlertCircle className="w-5 h-5 text-[var(--accent-fg)] shrink-0 mt-0.5" />
                        <div>
                            <p className="text-[10px] font-black uppercase tracking-[0.3em] text-[var(--accent-fg)] mb-1">Why this was rejected</p>
                            <p className="text-sm text-[var(--fg1)] leading-relaxed">{rejectionReason}</p>
                        </div>
                    </div>
                )}
                ...
                {!isEditMode && draftRestored && (
                    <div className="rounded-2xl border border-[var(--line-2)] bg-[var(--input-bg)] p-4 flex items-center justify-between gap-4">
                        <p className="text-xs font-bold text-[var(--fg1)]">We restored your in-progress release from where you left off.</p>
                        <button type="button" onClick={discardDraft} className="text-[10px] font-black uppercase tracking-widest text-[var(--accent-fg)] hover:text-[var(--fg0)] transition-colors shrink-0">
                            Discard & Start Fresh
                        </button>
                    </div>
                )}
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <button
                        ...
                        className="flex items-center text-[var(--fg0)] hover:text-[var(--fg0)] transition-colors text-[10px] font-black uppercase tracking-[0.3em] group"
                    >
                    ...
                    <div className="flex items-center gap-3">
                        {[1, 2, 3, 4].map(s => (
                            <div key={s} className="flex items-center gap-1.5">
                                <div className={`h-1.5 w-12 rounded-full transition-all duration-500 ${step >= s ? 'bg-red-600 shadow-glow-red' : 'bg-[var(--line-2)]'}`} />
                            </div>
                        ))}
                    </div>
                </div>
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                    ...
                    <div className="lg:col-span-4 space-y-8">
                        ...
                        >
                            {plan === 'none' ? (
                                <>
                                    <p className="label-caps text-[var(--amber-fg)] mb-2">Requirement Found</p>
                                    <h1 className="text-4xl md:text-5xl font-display italic tracking-tight text-[var(--fg0)] uppercase leading-[1.1] mb-6 pb-2">
                                        Subscription<br /><span className="text-gradient-red px-1">Required</span>
                                    </h1>
                                    <p className="text-xs text-[var(--fg0)] font-bold leading-relaxed">
                                ...
                                <>
                                    <p className="label-caps text-[var(--accent-fg)] mb-2">{isEditMode ? 'Resubmission — ' : ''}Phase 0{step} of 04</p>
                                    <h1 className="text-4xl md:text-5xl font-display italic tracking-tight text-[var(--fg0)] uppercase leading-[1.1] mb-6 pb-2">
                        ...
                        <div className="glass-card-premium p-6 rounded-3xl space-y-4">
                            <div className="flex items-center justify-between">
                                ...
                                <span className={`text-[10px] font-black uppercase px-3 py-1 rounded-full border ${plan === 'none' ? 'text-[var(--amber-fg)] bg-amber-500/10 border-amber-500/20' : 'text-[var(--accent-fg)] bg-red-600/10 border-red-600/20'}`}>
                        ...
                        <div className="lg:col-span-8">
                            {plan === 'none' ? (
                                ...
                                >
                                        ...
                                        {PLANS.map((p) => (
                                            ...
                                            >
                                                <div className="flex items-center justify-between mb-4">
                                                    <p className="text-[10px] font-black uppercase text-[var(--fg2)]">{p.subtitle}</p>
                                                    {selectedPlanId === p.id && <Check className="w-4 h-4 text-[var(--accent-fg)]" />}
                                                </div>
                                                <h3 className="text-lg font-black text-[var(--fg0)] mb-1 uppercase italic tracking-tight">{p.name}</h3>
                                                <p className="text-xl font-black text-[var(--accent-fg)] mb-6">₦{p.price.toLocaleString()} <span className="text-[10px] text-[var(--fg2)] uppercase">/ {p.period}</span></p>

                                                <div className="space-y-2 mb-8 flex-1">
                                                    {p.features.slice(0, 3).map((f, i) => (
                                                        <div key={i} className="flex items-center gap-2">
                                                            <div className="w-1 h-1 rounded-full bg-red-500" />
                                                            <span className="text-[9px] font-bold text-[var(--fg1)] uppercase">{f}</span>
                                                        </div>
                                                    ))}
                                                </div>

                                                <div className="mt-auto pt-4 border-t border-[var(--line)] flex items-center justify-between">
                                                    <span className="text-[10px] font-black uppercase text-[var(--fg2)] group-hover:text-[var(--fg0)] transition-colors">Subscribe Now</span>
                                                    <ArrowUpRight className="w-4 h-4 text-[var(--fg4)] group-hover:text-[var(--fg0)] group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-all" />
                                                </div>
                                            </button>
                                        ))}
                                    </div>
                                    ...
                                    {error && (
                                        <div className="mt-8 flex items-center gap-4 p-5 bg-red-600/10 border border-red-600/20 text-[var(--accent-fg)] rounded-2xl text-[11px] font-black uppercase tracking-widest leading-relaxed">
                                ...
                                <AnimatePresence mode="wait">
                                    ...
                                    >
                                        ...
                                        {/* Status Messages */}
                                        {error && (
                                            <div className="mb-8 flex items-center gap-4 p-5 bg-red-600/10 border border-red-600/20 text-[var(--accent-fg)] rounded-2xl text-[11px] font-black uppercase tracking-widest">
                                                <AlertCircle className="w-5 h-5 flex-shrink-0" />
                                                {error}
                                            </div>
                                        )}
                                        {success && (
                                            <div className="mb-8 flex items-center gap-4 p-5 bg-red-600/10 border border-red-600/20 text-[var(--accent-fg)] rounded-2xl text-[11px] font-black uppercase tracking-widest shadow-2xl">
                                        ...
                                        <form onSubmit={handleSubmit}>
                                                ...
                                                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-10">
                                                    <div className="grid md:grid-cols-2 gap-8">
                                                        <div className="space-y-2">
                                                            ...
                                                            <input type="text" required placeholder="Masterpiece Name" className="w-full bg-[var(--input-bg)] border border-[var(--line)] rounded-2xl px-6 py-4 text-[var(--fg0)] focus:border-red-600/50 outline-none transition-all font-bold text-sm"
                                                                value={formData.title} onChange={e => setFormData({ ...formData, title: e.target.value })} />
                                                        </div>
                                                        <div className="space-y-2">
                                                            <label className="label-caps opacity-50">Main Artist</label>
                                                            <input type="text" required placeholder="Artist or Band" className="w-full bg-[var(--input-bg)] border border-[var(--line)] rounded-2xl px-6 py-4 text-[var(--fg0)] focus:border-red-600/50 outline-none transition-all font-bold text-sm"
                                                    ...
                                                    <div className="space-y-4">
                                                        <div className="flex items-center justify-between">
                                                            <div>
                                                                ...
                                                                <p className="text-[10px] text-[var(--fg3)] font-bold mt-0.5">Optional — add one or more featured artists (ft.)</p>
                                                            </div>
                                                            <button type="button" onClick={addFeaturedArtist} className="flex items-center gap-2 text-[10px] font-black uppercase text-[var(--accent-fg)] hover:text-[var(--fg0)] transition-colors group">
                                                            ...
                                                            {featuredArtists.map((fa, i) => (
                                                                ...
                                                                >
                                                                    <div className="w-8 h-8 rounded-full bg-red-600/10 border border-red-600/20 flex items-center justify-center shrink-0">
                                                                        <span className="text-[10px] font-black text-[var(--accent-fg)]">ft.</span>
                                                                    </div>
                                                                    <input
                                                                        type="text"
                                                                        placeholder={`Featured Artist ${i + 1} name`}
                                                                        className="flex-1 bg-[var(--input-bg)] border border-[var(--line)] rounded-2xl px-6 py-4 text-[var(--fg0)] focus:border-red-600/50 outline-none transition-all font-bold text-sm"
                                                                        value={fa}
                                                                        onChange={e => updateFeaturedArtist(i, e.target.value)}
                                                                    />
                                                                    <button type="button" onClick={() => removeFeaturedArtist(i)} className="w-12 h-12 rounded-xl border border-[var(--line)] flex items-center justify-center text-[var(--fg0)] hover:bg-red-600/10 hover:text-[var(--accent-fg)] transition-all">
                                                                        <X className="w-4 h-4" />
                                                                    </button>
                                                                </motion.div>
                                                            ))}
                                                        ...
                                                        {featuredArtists.length === 0 && (
                                                            <p className="text-[10px] text-[var(--fg4)] font-bold italic px-1">No featured artists added — click "Add Feature" to include one</p>
                                                        )}
                                                    </div>
                                                    ...
                                                    <div className="grid md:grid-cols-2 gap-8">
                                                        <div className="space-y-2">
                                                            ...
                                                            <input type="text" required placeholder="e.g. Afrobeats, Hip-Hop" className="w-full bg-[var(--input-bg)] border border-[var(--line)] rounded-2xl px-6 py-4 text-[var(--fg0)] focus:border-red-600/50 outline-none transition-all font-bold text-sm"
                                                        ...
                                                        <div className="space-y-2">
                                                            ...
                                                            <input type="date" required className="w-full bg-[var(--input-bg)] border border-[var(--line)] rounded-2xl px-6 py-4 text-[var(--fg0)] focus:border-red-600/50 outline-none transition-all font-bold text-sm [color-scheme:dark]"
                                                                ...
                                                                return (
                                                                    <button
                                                                        ...
                                                                        className={`p-6 rounded-3xl border transition-all text-center relative group flex flex-col items-center justify-center gap-3 ${isSelected
                                                                                ? 'border-red-600 bg-red-600/10 text-[var(--fg0)] shadow-[0_0_20px_rgba(220,38,38,0.1)]'
                                                                                : isLocked
                                                                                    ? 'border-[var(--line-2)] bg-[var(--input-bg)] text-[var(--fg0)] cursor-not-allowed opacity-50'
                                                                                    : 'border-[var(--line)] bg-[var(--surface)] text-[var(--fg0)] hover:border-[var(--line-2)] hover:text-[var(--fg1)]'
                                                                            }`}
                                                                    >
                                                                        {isLocked && <Lock className="w-3 h-3 absolute top-4 right-4 text-[var(--fg0)]" />}
                                                                        <Music className={`w-5 h-5 transition-transform group-hover:scale-110 ${isSelected ? 'text-[var(--accent-fg)]' : 'text-[var(--fg0)]'}`} />
                                                    ...
                                                    <div className="pt-6">
                                                        <button type="button" onClick={() => {
                                                            ...
                                                            setStep(2);
                                                        }} className="w-full bg-[var(--invert-bg)] text-[var(--invert-fg)] hover:bg-red-600 hover:text-white py-5 rounded-2xl font-black text-sm uppercase tracking-widest transition-all shadow-2xl flex items-center justify-center gap-3 group active:scale-95">
                                                ...
                                                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-10">
                                                    <div className="grid md:grid-cols-2 gap-8">
                                                        <div className="space-y-2">
                                                            ...
                                                            <select className="w-full bg-[var(--input-bg)] border border-[var(--line)] rounded-2xl px-6 py-4 text-[var(--fg0)] focus:border-red-600/50 outline-none transition-all font-bold text-sm" value={formData.language} onChange={e => setFormData({ ...formData, language: e.target.value })}>
                                                                {LANGUAGES.map(l => <option key={l} value={l}>{l}</option>)}
                                                            </select>
                                                        </div>
                                                        <div className="space-y-2">
                                                            <label className="label-caps opacity-50">Label Designation</label>
                                                            <input type="text" placeholder="Independent Artist" className="w-full bg-[var(--input-bg)] border border-[var(--line)] rounded-2xl px-6 py-4 text-[var(--fg0)] focus:border-red-600/50 outline-none transition-all font-bold text-sm" value={formData.label} onChange={e => setFormData({ ...formData, label: e.target.value })} />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="grid md:grid-cols-2 gap-8">
                                                            ...
                                                            <div className="flex gap-4">
                                                                {['No', 'Yes'].map(opt => (
                                                                    <button key={opt} type="button" onClick={() => setFormData({ ...formData, explicit: opt })}
                                                                        className={`flex-1 py-4 px-4 rounded-xl border font-black text-[10px] uppercase tracking-widest transition-all ${formData.explicit === opt ? 'bg-red-600 border-red-600 text-black shadow-glow-red' : 'bg-[var(--surface)] border-[var(--line)] text-[var(--fg0)] hover:border-[var(--line-2)]'}`}>
                                                        ...
                                                        <div className="space-y-4">
                                                            ...
                                                            <input type="text" placeholder="e.g. US-ABC-21-00001" className="w-full bg-[var(--input-bg)] border border-[var(--line)] rounded-2xl px-6 py-4 text-[var(--fg0)] focus:border-red-600/50 outline-none transition-all font-bold text-sm" value={formData.isrc} onChange={e => setFormData({ ...formData, isrc: e.target.value })} />
                                                        </div>
                                                    </div>

                                                    <div className="space-y-4">
                                                        <label className="label-caps opacity-50">AI Utilization</label>
                                                        <select className="w-full bg-[var(--input-bg)] border border-[var(--line)] rounded-2xl px-6 py-4 text-[var(--fg0)] focus:border-red-600/50 outline-none transition-all font-bold text-sm" value={formData.ai_assisted} onChange={e => setFormData({ ...formData, ai_assisted: e.target.value })}>
                                                    ...
                                                    <div className="grid md:grid-cols-2 gap-8">
                                                        <div className="space-y-2">
                                                            ...
                                                            <input type="text" placeholder="2024 Artist Name" className="w-full bg-[var(--input-bg)] border border-[var(--line)] rounded-2xl px-6 py-4 text-[var(--fg0)] focus:border-red-600/50 outline-none transition-all font-bold text-sm" value={formData.copyright_date_release} onChange={e => setFormData({ ...formData, copyright_date_release: e.target.value })} />
                                                        </div>
                                                        <div className="space-y-2">
                                                            <label className="label-caps opacity-50">Copyright Recording (C)</label>
                                                            <input type="text" placeholder="2024 Artist Name" className="w-full bg-[var(--input-bg)] border border-[var(--line)] rounded-2xl px-6 py-4 text-[var(--fg0)] focus:border-red-600/50 outline-none transition-all font-bold text-sm" value={formData.copyright_date_recording} onChange={e => setFormData({ ...formData, copyright_date_recording: e.target.value })} />
                                                        </div>
                                                    </div>

                                                    <div className="pt-6">
                                                        <button type="button" onClick={() => setStep(3)} className="w-full bg-[var(--invert-bg)] text-[var(--invert-fg)] hover:bg-red-600 hover:text-white py-5 rounded-2xl font-black text-sm uppercase tracking-widest transition-all shadow-2xl flex items-center justify-center gap-3 group active:scale-95">
                                                ...
                                                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-10">
                                                    <div className="space-y-8">
                                                        <div className="flex items-center justify-between">
                                                            ...
                                                            <button type="button" onClick={addContributor} className="flex items-center gap-2 text-[10px] font-black uppercase text-[var(--accent-fg)] hover:text-[var(--fg0)] transition-colors group">
                                                            ...
                                                            <AnimatePresence>
                                                                {contributors.map((c, i) => (
                                                                    <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.95 }} key={i} className="flex gap-4 items-center group/item">
                                                                        <input type="text" placeholder="Legal Name" className="flex-1 bg-[var(--input-bg)] border border-[var(--line)] rounded-2xl px-6 py-4 text-[var(--fg0)] focus:border-red-600/50 outline-none transition-all font-bold text-sm" value={c.name} onChange={e => updateContributor(i, 'name', e.target.value)} />
                                                                        <select 
                                                                            className="w-48 bg-[var(--input-bg)] border border-red-600/30 rounded-2xl px-6 py-4 text-[var(--accent-fg)] focus:border-red-600 outline-none transition-all font-black text-[10px] uppercase tracking-widest appearance-none cursor-pointer hover:bg-red-600/5" 
                                                                            value={c.role} 
                                                                            onChange={e => updateContributor(i, 'role', e.target.value)}
                                                                        >
                                                                            {ROLES.map(r => <option key={r} value={r} className="bg-[var(--input-bg)] text-[var(--fg0)]">{r}</option>)}
                                                                        </select>
                                                                        <button type="button" onClick={() => removeContributor(i)} className="w-12 h-12 rounded-xl border border-[var(--line)] flex items-center justify-center text-[var(--fg0)] hover:bg-red-600/10 hover:text-[var(--accent-fg)] transition-all">
                                                                            <X className="w-5 h-5" />
                                                                        </button>
                                                                    </motion.div>
                                                                ))}
                                                    ...
                                                    <div className="space-y-8">
                                                        <div className="flex items-center justify-between">
                                                            ...
                                                            <button type="button" onClick={addSongwriter} className="flex items-center gap-2 text-[10px] font-black uppercase text-[var(--accent-fg)] hover:text-[var(--fg0)] transition-colors group">
                                                            ...
                                                            <AnimatePresence>
                                                                {songwriters.map((s, i) => (
                                                                    <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.95 }} key={i} className="flex gap-4 items-center">
                                                                        <input type="text" placeholder="Full Legal Name" className="flex-1 bg-[var(--input-bg)] border border-[var(--line)] rounded-2xl px-6 py-4 text-[var(--fg0)] focus:border-red-600/50 outline-none transition-all font-bold text-sm" value={s} onChange={e => updateSongwriter(i, e.target.value)} />
                                                                        <button type="button" onClick={() => removeSongwriter(i)} className="w-12 h-12 rounded-xl border border-[var(--line)] flex items-center justify-center text-[var(--fg0)] hover:bg-red-600/10 hover:text-[var(--accent-fg)] transition-all">
                                                                            <X className="w-5 h-5" />
                                                                        </button>
                                                                    </motion.div>
                                                                ))}
                                                    ...
                                                    <div className="pt-6">
                                                        <button type="button" onClick={() => setStep(4)} className="w-full bg-[var(--invert-bg)] text-[var(--invert-fg)] hover:bg-red-600 hover:text-white py-5 rounded-2xl font-black text-sm uppercase tracking-widest transition-all shadow-2xl flex items-center justify-center gap-3 group active:scale-95">
                                            ...
                                            {step === 4 && (
                                                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-12">
                                                    <div className="space-y-8">
                                                        <div className="flex items-center justify-between">
                                                            ...
                                                            {formData.type !== 'Single' && (
                                                                <button type="button" onClick={addTrack} className="flex items-center gap-2 text-[10px] font-black uppercase text-[var(--accent-fg)] hover:text-[var(--fg0)] transition-colors group">
                                                        ...
                                                        <div className="space-y-6">
                                                            {tracks.map((t, i) => (
                                                                <div key={i} className="p-6 rounded-3xl bg-[var(--surface)] border border-[var(--line)] space-y-6 relative group/track">
                                                                    <div className="flex items-center justify-between">
                                                                        <span className="text-[10px] font-black text-[var(--accent-fg)] uppercase tracking-widest">Track #{i + 1}</span>
                                                                        {tracks.length > 1 && (
                                                                            <button type="button" onClick={() => removeTrack(i)} className="p-2 text-[var(--fg4)] hover:text-[var(--accent-fg)] transition-colors">
                                                                                <X className="w-4 h-4" />
                                                                            </button>
                                                                        )}
                                                                    </div>
                                                                    ...
                                                                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                                                                        <div className="space-y-2">
                                                                            <label className="text-[9px] font-black uppercase text-[var(--fg2)] tracking-widest">Title</label>
                                                                            <input type="text" placeholder="Song Title" className="w-full bg-[var(--input-bg)] border border-[var(--line)] rounded-xl px-4 py-3 text-[var(--fg0)] text-xs font-bold outline-none focus:border-red-500/50"
                                                                                value={t.title} onChange={e => updateTrack(i, 'title', e.target.value)} />
                                                                        </div>
                                                                        <div className="space-y-2">
                                                                            <label className="text-[9px] font-black uppercase text-[var(--fg2)] tracking-widest">Artist</label>
                                                                            <input type="text" placeholder="Artist Name" className="w-full bg-[var(--input-bg)] border border-[var(--line)] rounded-xl px-4 py-3 text-[var(--fg0)] text-xs font-bold outline-none focus:border-red-500/50"
                                                                                value={t.artist} onChange={e => updateTrack(i, 'artist', e.target.value)} />
                                                                        </div>
                                                                        <div className="space-y-2">
                                                                            <label className="text-[9px] font-black uppercase text-[var(--fg2)] tracking-widest">Featured Artist</label>
                                                                            <input type="text" placeholder="Featured (optional)" className="w-full bg-[var(--input-bg)] border border-[var(--line)] rounded-xl px-4 py-3 text-[var(--fg0)] text-xs font-bold outline-none focus:border-red-500/50"
                                                                                value={t.featured_artist} onChange={e => updateTrack(i, 'featured_artist', e.target.value)} />
                                                                        </div>
                                                                        <div className="space-y-2">
                                                                            <label className="text-[9px] font-black uppercase text-[var(--fg2)] tracking-widest">Genre</label>
                                                                            <input type="text" placeholder="Genre" className="w-full bg-[var(--input-bg)] border border-[var(--line)] rounded-xl px-4 py-3 text-[var(--fg0)] text-xs font-bold outline-none focus:border-red-500/50"
                                                                                value={t.genre} onChange={e => updateTrack(i, 'genre', e.target.value)} />
                                                                        </div>
                                                                        <div className="space-y-2">
                                                                            <label className="text-[9px] font-black uppercase text-[var(--fg2)] tracking-widest">Songwriter</label>
                                                                            <input type="text" placeholder="Songwriter (optional)" className="w-full bg-[var(--input-bg)] border border-[var(--line)] rounded-xl px-4 py-3 text-[var(--fg0)] text-xs font-bold outline-none focus:border-red-500/50"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        className={`w-full py-8 border-2 border-dashed rounded-2xl transition-all cursor-pointer flex flex-col items-center justify-center gap-3 ${t.file ? 'border-red-600/30 bg-red-600/5' : 'border-[var(--line)] bg-[var(--surface)] hover:border-[var(--line-2)]'}`}
                                                                    >
                                                                        <Music className={`w-5 h-5 ${t.file ? 'text-[var(--accent-fg)]' : 'text-[var(--fg4)]'}`} />
                                                                        <p className="text-[10px] font-black uppercase tracking-widest text-[var(--fg0)]">
                                                    ...
                                                    <div className="grid md:grid-cols-1 gap-8 pt-8 border-t border-[var(--line)]">
                                                        <div className="space-y-4">
                                                            ...
                                                            <div
                                                                ...
                                                                className="h-64 rounded-[2rem] border-2 border-dashed border-[var(--line)] bg-[var(--surface)] hover:bg-red-600/5 hover:border-red-600/30 transition-all cursor-pointer group relative overflow-hidden flex items-center justify-center max-w-lg mx-auto w-full"
                                                            >
                                                                {(coverImageFile || existingCoverUrl) ? (
                                                                    <>
                                                                        ...
                                                                        <div className="relative z-10 flex flex-col items-center gap-3">
                                                                            <div className="w-12 h-12 rounded-xl bg-[var(--surface-hover)] backdrop-blur-md flex items-center justify-center">
                                                                                <Upload className="w-6 h-6 text-[var(--fg0)]" />
                                                                            </div>
                                                                            <p className="text-[10px] font-black uppercase text-[var(--fg0)] tracking-widest">
                                                                    ...
                                                                    <div className="flex flex-col items-center">
                                                                        <div className="p-5 rounded-2xl bg-[var(--surface-hover)] border border-[var(--line)] mb-6 group-hover:scale-110 transition-transform shadow-2xl">
                                                                            <Upload className="w-8 h-8 text-[var(--fg0)] group-hover:text-[var(--accent-fg)] transition-colors" />
                                                                        </div>
                                                                        <p className="text-xs font-black uppercase text-[var(--fg0)] group-hover:text-[var(--fg0)] tracking-widest">Choose Image</p>
                                                                        <p className="text-[10px] font-bold text-[var(--fg0)] mt-2 italic">300x300px Recommended</p>
                                                                    </div>
                                                                )}
                                                    ...
                                                    <div className="pt-8 border-t border-[var(--line)]">
                                                        ...
                                                        <p className="text-[10px] font-black text-[var(--fg0)] uppercase tracking-widest text-center mt-8 px-10 leading-relaxed">
