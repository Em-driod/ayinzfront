...
export default function Landing() {
  ...
  const Pill = ({ p }: { p: typeof platforms[0] }) => (
    <span className="inline-flex items-center gap-2.5 px-5 py-2.5 mx-2 rounded-full border border-[var(--line)] bg-[var(--surface-2)] shrink-0 select-none">
      <p.Icon size={13} style={{ color: p.color }} />
      <span className="text-[11px] font-semibold text-[var(--fg1)] whitespace-nowrap tracking-wide">{p.name}</span>
    </span>
  );
  ...
  const css = `
    ...
    .grad-border { background: linear-gradient(var(--bg1), var(--bg1)) padding-box, linear-gradient(135deg, rgba(255,255,255,0.22) 0%, rgba(255,255,255,0.06) 50%, rgba(255,255,255,0.16) 100%) border-box; border: 1px solid transparent; }
  `;

  return (
    <div className="relative bg-[var(--bg0)] text-[var(--fg0)] overflow-x-hidden selection:bg-red-600/80 selection:text-white">
      <style>{css}</style>
      ...
      <section className="relative min-h-[100svh] lg:min-h-screen flex items-center overflow-hidden pt-24 pb-12 lg:pt-28 lg:pb-20">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute inset-0 bg-[var(--bg0)]/40" />
        </div>
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_90%_70%_at_30%_15%,rgba(255,255,255,0.035)_0%,transparent_60%)]" />
        <div className="absolute bottom-0 inset-x-0 h-40 bg-gradient-to-t from-[var(--bg0)] to-transparent" />
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 grid lg:grid-cols-[1.05fr_0.95fr] gap-8 lg:gap-8 items-center w-full">
          ...
          <motion.div style={{ opacity: heroOp }} className="order-2 lg:order-1 text-left">
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full border border-[var(--line-2)] bg-[var(--surface)] backdrop-blur-sm mb-6 lg:mb-8">
              <span className="w-1.5 h-1.5 rounded-full bg-red-500 animate-pulse shadow-[0_0_6px_rgba(225,29,72,1)]" />
              <span className="text-[9px] uppercase tracking-[0.4em] font-bold text-[var(--fg2)]">Made for independent artists</span>
            </motion.div>
            ...
            <motion.div variants={stagger(0.3)} initial="hidden" animate="show" className="mb-5 lg:mb-7">
              <div className="overflow-hidden">
                <motion.h1 variants={fadeUp}
                  className="text-[clamp(2.4rem,6.4vw,5rem)] font-black tracking-[-0.03em] leading-[0.98] text-[var(--fg0)]">
                  Your sound.
                </motion.h1>
              </div>
              <div className="overflow-hidden">
              ...
              <div className="overflow-hidden mt-1">
                <motion.div variants={fadeUp}>
                  <span className="text-[clamp(2.4rem,6.4vw,5rem)] italic font-serif tracking-[-0.02em] leading-[0.98] text-[var(--accent-fg)]">
                    needs to be.
                  </span>
                </motion.div>
              </div>
            ...
            <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.8, duration: 0.9 }}
              className="text-sm md:text-base text-[var(--fg2)] font-light max-w-md leading-relaxed mb-7 lg:mb-10">
            ...
            <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}
              ...
              <Link to="/login"
                className="flex items-center gap-2 px-8 py-4 rounded-full border border-[var(--line-2)] bg-[var(--surface)] text-[11px] font-bold uppercase tracking-[0.2em] text-[var(--fg2)] hover:text-[var(--fg1)] hover:border-[var(--line-2)] hover:bg-[var(--surface-hover)] transition-all duration-300 backdrop-blur-sm">
                Sign In
              </Link>
            </motion.div>
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1.2, duration: 0.8 }}
              ...
              <div className="flex -space-x-3">
                {['/girl.jpeg', '/fine.jpeg', '/serah.jpeg'].map((src, i) => (
                  <div key={i} className="w-9 h-9 rounded-full border-2 border-[var(--bg0)] overflow-hidden shrink-0">
                    <img src={src} alt="Artist on Ayinz" className="w-full h-full object-cover" />
                  </div>
                ))}
              </div>
              <p className="text-[11px] text-[var(--fg3)] font-medium leading-tight">
                <span className="text-[var(--fg0)] font-black">10,000+</span> artists already<br className="hidden sm:block" /> distributing with Ayinz
              </p>
            </motion.div>
          </motion.div>
        </div>
      ...
      {/* ══════════════════════════════════════════════════════════ PLATFORMS */}
      <section id="platforms" className="relative py-20 overflow-hidden border-y border-[var(--line)]">
        <div className="max-w-6xl mx-auto px-6 mb-12 text-center">
          <motion.div initial={{ opacity: 0, y: 14 }} whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }} transition={{ duration: 0.6 }}>
            <p className="text-[8px] uppercase tracking-[0.5em] font-bold text-[var(--fg3)] mb-3">Distribution Network</p>
            <h2 className="text-2xl md:text-3xl font-black tracking-tight text-[var(--fg0)]">Your music. Every platform.</h2>
          </motion.div>
        </div>
        ...
        {/* Edge fades */}
        <div className="absolute inset-y-0 left-0 w-32 bg-gradient-to-r from-[var(--bg0)] to-transparent pointer-events-none z-10" />
        <div className="absolute inset-y-0 right-0 w-32 bg-gradient-to-l from-[var(--bg0)] to-transparent pointer-events-none z-10" />
      </section>
      ...
      <section id="features" className="relative py-28 md:py-36">
        <div className="max-w-6xl mx-auto px-6">
          <motion.div variants={stagger(0)} initial="hidden" whileInView="show"
            ...
            <motion.div variants={fadeUp}>
              <p className="text-[8px] uppercase tracking-[0.5em] font-bold text-[var(--fg3)] mb-4">Why Ayinz</p>
              <h2 className="text-4xl md:text-5xl font-black tracking-tight leading-[1.05] text-[var(--fg0)]">
                Built for artists.<br />
                <span className="text-[var(--fg4)] font-light italic font-serif">Not for labels.</span>
              </h2>
            </motion.div>
            <motion.div variants={fadeUp}>
              <Link to="/register"
                className="inline-flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.2em] text-[var(--fg2)] hover:text-[var(--fg0)] transition-colors group">
          ...
          <motion.div variants={stagger(0.1)} initial="hidden" whileInView="show"
            ...
            {features.map((f, i) => (
              <motion.div key={i} variants={fadeUp}
                whileHover={{ y: -6 }}
                className="group relative p-6 rounded-2xl border border-[var(--line)] bg-[var(--surface-2)] hover:border-[var(--line-2)] hover:bg-[var(--surface)] transition-all duration-400 overflow-hidden cursor-default backdrop-blur-sm">
                ...
                <div className="w-9 h-9 rounded-xl border border-[var(--line)] bg-[var(--surface-hover)] flex items-center justify-center mb-5 group-hover:border-[var(--line-2)] group-hover:bg-[var(--surface-hover)] transition-all duration-300">
                  <f.Icon className="w-4 h-4 text-[var(--fg2)] group-hover:text-[var(--fg0)] transition-colors" />
                </div>
                <h3 className="text-sm font-black text-[var(--fg0)] mb-2.5">{f.title}</h3>
                <p className="text-xs text-[var(--fg3)] leading-relaxed font-light">{f.body}</p>
              </motion.div>
            ))}
          </motion.div>
        </div>
      ...
      {/* ══════════════════════════════════════════════════════════ STATS */}
      <section className="border-y border-[var(--line)] py-16 bg-[var(--surface-2)]">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:divide-x divide-[var(--line)]">
            {[
              ...
              <motion.div key={i} initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }}
                ...
                <p className="text-4xl md:text-5xl font-black text-[var(--fg0)] tabular-nums leading-none">
                  <Counter to={val} suffix={suffix} />
                </p>
                <p className="text-[9px] uppercase tracking-[0.35em] font-bold text-[var(--fg4)] mt-2">{lab}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section id="pricing" className="relative py-28 md:py-36 overflow-hidden">
        <div className="max-w-6xl mx-auto px-6">
          <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }}
            ...
            <p className="text-[8px] uppercase tracking-[0.5em] font-bold text-[var(--fg3)] mb-4">Membership</p>
            <h2 className="text-4xl md:text-5xl font-black tracking-tight text-[var(--fg0)] mb-3">One price. Unlimited releases.</h2>
            <p className="text-sm text-[var(--fg3)] font-light">No hidden fees. No royalty cuts. Cancel anytime.</p>
          </motion.div>
            ...
            {plans.map((plan, i) => (
              <motion.div key={i} variants={fadeUp} whileHover={{ y: -6 }}
                className={`relative flex flex-col p-6 rounded-2xl transition-all duration-400 overflow-hidden
                  ${plan.hot ? 'grad-border bg-[var(--bg1)] shadow-[0_0_60px_rgba(255,255,255,0.05)]' : 'border border-[var(--line)] bg-[var(--surface-2)] hover:border-[var(--line-2)] hover:bg-[var(--surface)]'}`}>
                {plan.hot && (
                  <div className="absolute top-0 inset-x-0 h-px bg-gradient-to-r from-transparent via-white/40 to-transparent" />
                )}
                {plan.hot && (
                  <span className="absolute top-4 right-4 text-[8px] font-black uppercase tracking-[0.15em] bg-[var(--invert-bg)] text-[var(--invert-fg)] px-2.5 py-1 rounded-full">Popular</span>
                )}

                <div className="mb-6">
                  <h3 className="text-base font-black text-[var(--fg0)]">{plan.name}</h3>
                  <p className="text-[9px] text-[var(--fg3)] uppercase tracking-[0.2em] font-bold mt-0.5">{plan.accounts}</p>
                </div>

                <div className="mb-7">
                  <span className="text-4xl font-black text-[var(--fg0)]">{plan.price}</span>
                  <span className="text-[10px] text-[var(--fg4)] font-bold ml-1.5 uppercase tracking-wider">/yr</span>
                </div>

                <ul className="space-y-2.5 mb-8 flex-1">
                  {['Unlimited releases', 'Live analytics', '100% royalties', '4–7 day SLA', 'Direct payouts'].map(feat => (
                    <li key={feat} className="flex items-center gap-2.5">
                      <Check className={`w-3 h-3 shrink-0 ${plan.hot ? 'text-[var(--fg1)]' : 'text-[var(--fg5)]'}`} />
                      <span className="text-[11px] text-[var(--fg2)] font-medium">{feat}</span>
                    </li>
                  ))}
                </ul>
                ...
                <Link to={`/register?plan=${plan.id}`}
                  className={`w-full py-3 text-center text-[10px] font-black uppercase tracking-[0.2em] rounded-xl transition-all duration-300
                    ${plan.hot ? 'bg-[var(--invert-bg)] hover:bg-[var(--invert-hover)] text-[var(--invert-fg)] shadow-lg shadow-white/10' : 'border border-[var(--line)] bg-[var(--surface)] hover:bg-[var(--invert-bg)] hover:text-[var(--invert-fg)] text-[var(--fg1)]'}`}>
                  Get Started
                </Link>
              </motion.div>
            ))}
      ...
      {/* ══════════════════════════════════════════════════════════ TESTIMONIALS */}
      <section id="artists" className="relative py-28 md:py-36 border-t border-[var(--line)]">
        <div className="max-w-6xl mx-auto px-6">
          <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }} className="mb-16">
            <p className="text-[8px] uppercase tracking-[0.5em] font-bold text-[var(--fg3)] mb-4">Artists</p>
            <h2 className="text-4xl md:text-5xl font-black tracking-tight text-[var(--fg0)]">What artists say.</h2>
          </motion.div>
          ...
          <motion.div variants={stagger(0.1)} initial="hidden" whileInView="show"
            ...
            {testimonials.map((t, i) => (
              <motion.div key={i} variants={fadeUp} whileHover={{ y: -6 }}
                className="group relative flex flex-col p-7 rounded-2xl border border-[var(--line)] bg-[var(--surface-2)] hover:border-[var(--line-2)] hover:bg-[var(--surface)] transition-all duration-400 overflow-hidden cursor-default">
                ...
                <span className="text-5xl font-black text-[var(--fg5)] leading-none mb-5 select-none">&ldquo;</span>
                <p className="text-sm text-[var(--fg2)] font-light leading-relaxed flex-1 mb-8">{t.quote}</p>

                <div className="flex items-center gap-3 pt-6 border-t border-[var(--line)]">
                  {t.photo
                    ? <img src={t.photo} alt={t.name} className="w-10 h-10 rounded-full object-cover border border-[var(--line-2)] shrink-0 group-hover:border-[var(--line-2)] transition-colors" />
                    : <div className="w-10 h-10 rounded-full bg-[var(--surface-hover)] border border-[var(--line-2)] flex items-center justify-center shrink-0">
                        <span className="text-xs font-black text-[var(--fg1)]">{t.name[0]}</span>
                      </div>
                  }
                  <div>
                    <p className="text-sm font-black text-[var(--fg0)]">{t.name}</p>
                    <p className="text-[9px] uppercase tracking-[0.25em] text-[var(--fg4)] font-bold mt-0.5">{t.role}</p>
                  </div>
                </div>
              </motion.div>
            ))}
      ...
      {/* ══════════════════════════════════════════════════════════ CTA */}
      <section className="relative py-36 overflow-hidden border-t border-[var(--line)]">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          <motion.div initial={{ opacity: 0, y: 22 }} whileInView={{ opacity: 1, y: 0 }}
            ...
            <p className="text-[8px] uppercase tracking-[0.55em] font-bold text-[var(--fg3)] mb-8">Ready?</p>
            <h2 className="text-5xl md:text-7xl font-black tracking-[-0.03em] leading-[0.97] text-[var(--fg0)] mb-5">
              Your music deserves<br />
              <span className="italic font-serif font-light text-[var(--accent-fg)]">the world.</span>
            </h2>
            <p className="text-sm text-[var(--fg3)] font-light mb-12 max-w-sm mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              ...
              <Link to="/login"
                className="flex items-center gap-2 px-8 py-4 rounded-full border border-[var(--line)] bg-[var(--surface-2)] text-[11px] font-bold uppercase tracking-[0.2em] text-[var(--fg3)] hover:text-[var(--fg1)] hover:border-[var(--line-2)] transition-all duration-300 backdrop-blur-sm">
                Sign In
              </Link>
            </div>
          </motion.div>
      ...
      {/* ══════════════════════════════════════════════════════════ FOOTER */}
      <footer className="border-t border-[var(--line)] py-16 bg-[var(--bg1)]">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-10 mb-14">
            <div className="col-span-2 md:col-span-1">
              <div className="flex items-center gap-2.5 mb-5">
                <div className="w-7 h-7 rounded-lg overflow-hidden border border-[var(--line-2)]">
              ...
              <p className="text-[10px] text-[var(--fg4)] font-light leading-relaxed max-w-[170px]">
                Boutique global music distribution for independent artists.
              </p>
              <div className="flex gap-4 mt-6">
                <FaInstagram size={14} className="text-[var(--fg5)] hover:text-[var(--fg1)] transition-colors cursor-pointer" />
                <FaXTwitter  size={14} className="text-[var(--fg5)] hover:text-[var(--fg1)] transition-colors cursor-pointer" />
              </div>
            </div>
            ...
            {[
              ...
              <div key={col.label}>
                <p className="text-[8px] font-black uppercase tracking-[0.4em] text-[var(--fg5)] mb-5">{col.label}</p>
                <ul className="space-y-3">
                  {col.links.map(link => (
                    <li key={link.l}>
                      <Link to={link.to} className="text-[10px] font-bold uppercase tracking-widest text-[var(--fg4)] hover:text-[var(--fg1)] transition-colors">{link.l}</Link>
                    </li>
                  ))}
                </ul>
              </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-3 pt-8 border-t border-[var(--line)]">
            <p className="text-[9px] font-bold uppercase tracking-[0.3em] text-[var(--fg5)]">© {new Date().getFullYear()} Ayinz. All rights reserved.</p>
            <p className="text-[9px] font-bold uppercase tracking-[0.3em] text-[var(--fg5)]">Distributed with pride · Lagos, Nigeria</p>
          </div>
        </div>
      </footer>
    </div>
