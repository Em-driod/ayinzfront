...
const plans = [
  ...
  },
  {
    id: 'premium_plus',
    name: 'Premium Plus',
    subtitle: 'Growing Label',
    price: 80_000,
    original: 100_000,
    accounts: '8–10 Artist Accounts',
    icon: Users,
    popular: false,
    features: [
      '8–10 Artist Accounts',
      'Unlimited releases',
      'Priority delivery',
      'Daily stream insights',
      'Royalty Advances',
              ...
              <div className="p-6 flex-1">
                ...
                <div className="mb-6">
                  <div className="flex items-end gap-1.5 mb-0.5">
                    ...
                    <span className={`text-xs font-bold pb-1 ${plan.popular ? 'text-zinc-500' : 'text-zinc-700'}`}>/mo</span>
                  </div>
